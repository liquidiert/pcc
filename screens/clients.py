...
class ClientScreen:
    ...
    def refresh(self):
        ...
        # self.root.ids.root_box.ids.screen_manager_content.ids.client_screen_box.ids.clients_table.row_data = self.to_display
    ...
    def get_dialog_template(
        ...
        """
        Builds a `MDDialog` with custom date picker, on cancel and save functions
        """
        delete_btn = (
            MDFlatButton(
                text="DELETE",
